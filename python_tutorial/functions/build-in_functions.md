...
**Ön bilgi:** Bu bölümü anlayabilmek için [expression](./python_tutorial/blob/main/python_tutorial/temel_bilgiler/statements_expressions_keywords.md#2) ve [statement](./python_tutorial/blob/main/python_tutorial/temel_bilgiler/statements_expressions_keywords.md#3) kavramlarını bilmeniz gerekmektedir. Gerekli bilgiler için [tıklayınız](./e-k-eyupoglu/python_tutorial/blob/main/python_tutorial/temel_bilgiler/statements_expressions_keywords.md).
...
**Ön bilgi:** Bu bölümü anlayabilmek için [expression](./python_tutorial/blob/main/python_tutorial/temel_bilgiler/statements_expressions_keywords.md#2) ve [statement](./python_tutorial/blob/main/python_tutorial/temel_bilgiler/statements_expressions_keywords.md#3) kavramlarını bilmeniz gerekmektedir. Gerekli bilgiler için [tıklayınız](./python_tutorial/blob/main/python_tutorial/temel_bilgiler/statements_expressions_keywords.md).
