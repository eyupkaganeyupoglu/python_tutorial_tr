...
| `ReferenceError` | Bir [garbage collection](./python_tutorial/blob/main/python_tutorial/temel_bilgiler/basic_concepts.md#12) referansına erişmek için zayıf bir proxy referansı kullanıldığında yükseltilen hata mesajıdır. |
...
| `UnboundLocalError` | Local namespace'de bulunan bir obje üzerinde işlem yapmaya çalışırken yükseltilebilecek hata mesajıdır. Ayrıntılı bilgi için [tıklayınız](./python_tutorial/blob/main/python_tutorial/functions/functions.md#1.6). |
